...
def get_single_song(update: Update, context: CallbackContext):
    ...
    if url.startswith(("http://", "https://")):
        os.system(f'spotdl download "{url}" --audio bandcamp --client-secret 5844159a9506462fa5fd2d190238c37e
--client-id c0e1785900eb4c0582b1f76b0398d9cf --threads 12 --format mp3 --bitrate 320k --lyrics genius')
